...
internal class _UserEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("level", "name", "money", "curExp", "avator");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("level", "name", "money", "curExp", "avator");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("level", "name", "money", "curExp", "avator");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("level", "name", "money", "curExp", "avator");
    ...
    public function _UserEntityMetadata(user : _Super_User)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["curExp"] = new Array();
            model_internal::dependentsOnMap["avator"] = new Array();
    ...
    public function get isValid() : Boolean
    {
     ...
     [Bindable(event="propertyChange")] 
     public function get isCurExpAvailable():Boolean
     {
        return true;
     }                       
                  
     [Bindable(event="propertyChange")] 
     public function get isAvatorAvailable():Boolean
     {
        return true;
     }                       
    ...
    [Bindable(event="propertyChange")]   
    public function get curExpStyle():com.adobe.fiber.styles.Style
    {
		return model_internal::_nullStyle;		
    }      
    
    [Bindable(event="propertyChange")]   
    public function get avatorStyle():com.adobe.fiber.styles.Style
    {
		return model_internal::_nullStyle;		
    }      
