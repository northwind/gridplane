...
internal class _ResultEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("t", "code", "msg");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("t", "code", "msg");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("t", "code", "msg");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("t", "code", "msg");
    ...
    public function _ResultEntityMetadata(result : _Super_Result)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["t"] = new Array();
        ...
        model_internal::_instance = result;     
    }
    ...
    public function get isValid() : Boolean
    {
     ...
     [Bindable(event="propertyChange")] 
     public function get isTAvailable():Boolean
     {
        return true;
     }                       
    ...
    [Bindable(event="propertyChange")]   
    public function get tStyle():com.adobe.fiber.styles.Style
    {
